...
import { notifyFollowersNewPost } from '../../appwrite/NotificationHelpers';
...
// 		// If post has image from Appwrite bucket
// 		if (post.featuredImage) {
// 			const fileUrl = bucketService.getFileDownload({ fileId: post.featuredImage }).preview;
...
// 				const { file, error: uploadError } = await bucketService.createFile({
...
// 				animate={{ opacity: 1, y: 0 }}
// 				transition={{ duration: 0.3 }}
// 				className="bg-white dark:bg-zinc-900 rounded-2xl p-6 md:p-8 shadow-lg"
// 			>
// 				<h1 className="text-2xl mb-8 font-bold text-gray-900 dark:text-white">
// 					{id ? "Edit Post" : "Create New Post"}
// 				</h1>
// 				<form onSubmit={handleSubmit} className="space-y-6">
// 					{/* Image Upload / Preview */}
// 					<div
// 						className="relative h-76 bg-gray-50 dark:bg-zinc-800 rounded-xl border-2 border-dashed border-gray-200 dark:border-zinc-700 overflow-hidden"
...
// 										setPreviewUrl(null);
// 									}}
// 									className="absolute top-2 right-2 p-1.5 bg-rose-100 dark:bg-rose-900/20 text-rose-600 dark:text-rose-500 rounded-lg hover:bg-rose-200 dark:hover:bg-rose-900/40 transition-colors"
// 								>
// 									<X size={16} />
// 								</button>
// 							</div>
...
// 						}
// 						required
// 						className="w-full px-4 py-3 bg-gray-50 dark:bg-zinc-800 text-gray-800 dark:text-gray-200 placeholder-gray-500 dark:placeholder-gray-400 rounded-lg border border-gray-200 dark:border-zinc-700 focus:border-blue-500 dark:focus:border-blue-400 outline-none transition-colors"
// 					/>
...
// 						}
// 						required
// 						className="w-full h-32 px-4 py-3 bg-gray-50 dark:bg-zinc-800 text-gray-800 dark:text-gray-200 placeholder-gray-500 dark:placeholder-gray-400 rounded-lg border border-gray-200 dark:border-zinc-700 focus:border-blue-500 dark:focus:border-blue-400 outline-none transition-colors resize-none scrollbar-thin scrollbar-thumb-zinc-500 scrollbar-track-transparent"
// 					/>

// 					{/* Visibility Toggle */}
// 					<div className="relative flex w-fit p-1 rounded-xl bg-gray-100 dark:bg-[#0A0A0A] border border-gray-200 dark:border-[#1F1F1F] transition-colors duration-300">
// 						<div
// 							className={`absolute h-[calc(100%-0.5rem)] w-[calc(50%-0.25rem)] rounded-lg bg-white/40 dark:bg-white/10 backdrop-blur-md shadow-sm transition-all duration-300 ease-in-out ${formData.visibility === "public"
// 								? "translate-x-0"
// 								: "translate-x-full"
// 								}`}
// 						></div>
...
// 									setFormData({
// 										...formData,
// 										visibility: option.toLowerCase(),
// 									})
// 								}
// 								className={`relative z-10 w-18 text-sm font-medium py-1.5 rounded-lg transition-colors duration-200 ${formData.visibility === option.toLowerCase()
...
// 						type="submit"
// 						disabled={loading}
// 						className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 dark:from-blue-500 dark:to-blue-600 hover:from-blue-700 hover:to-blue-800 text-white rounded-lg transition-all duration-300 transform hover:-translate-y-0.5 disabled:opacity-50"
// 					>
